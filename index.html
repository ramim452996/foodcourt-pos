...
<head>
    ...
    <!-- Fonts: Times New Roman (English) + Sonar Bangla (Bengali) fallback to Noto Sans Bengali -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+Bengali:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500;700&display=swap" rel="stylesheet">
    ...
    <script>
        tailwind.config = {
            ...
            theme: {
                extend: {
                    fontFamily: {
                        sans: ['"Times New Roman"', '"Sonar Bangla"', '"Noto Sans Bengali"', 'system-ui', 'serif'],
    ...
    <style>
        ...
        /* ── Font: Times New Roman for English, Sonar Bangla for বাংলা ── */
        @font-face {
                            ...
                            <template x-if="mobileLayout === 'grid'">
                                <div class="grid w-full"
                                    ...
                                    <template x-for="item in filteredMenuItems" :key="item.id">
                                        <div class="food-card rounded-[24px] sm:rounded-[32px] p-2 overflow-hidden flex flex-col justify-between group border relative"
                                             :class="isDark ? 'bg-obsidian-900/90 border-white/[0.08]' : 'bg-[#faf4f8]/80 backdrop-blur-md border-white shadow-sm hover:shadow-md'">
                                            
                                            <div class="relative h-32 sm:h-40 w-full overflow-hidden bg-zinc-100 dark:bg-zinc-900 rounded-[20px] sm:rounded-[24px] flex-shrink-0">
